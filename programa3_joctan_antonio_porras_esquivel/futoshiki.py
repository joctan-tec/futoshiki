...
def jugar():
    ...
    ventana_juego.geometry("940x700")
    ...
    nombre_entry.place(x=247,y=105,width=404,height=24)
      ...
      #Llamada del crono si se activa en las configuraciones
    lista_crono = [0,59,55]

    if nivel[1] == 1 or nivel[1]=="1":
        
        
        #encabezados
        crono_cuadro_hora= Label(ventana_juego, borderwidth=3,relief=RIDGE,justify=CENTER,bg="#C8FFFC",text="HORAS", font="times 14")
        crono_cuadro_hora.place(x=40,y=582,width=90, height=30)

        crono_cuadro_min= Label(ventana_juego, borderwidth=3,relief=RIDGE,justify=CENTER,bg="#C8FFFC",text="MINUTOS", font="times 14")
        crono_cuadro_min.place(x=129,y=582,width=110, height=30)
        crono_cuadro_seg= Label(ventana_juego, borderwidth=3,relief=RIDGE,justify=CENTER,bg="#C8FFFC",text="SEGUNDOS", font="times 14")
        crono_cuadro_seg.place(x=237,y=582,width=130, height=30)



            #cuadros de los numeros



        cuadrito_de_hora= Label(ventana_juego, borderwidth=3,relief=RIDGE,justify=CENTER,bg="#C8FFFC",text=0, font="times 18")
        cuadrito_de_hora.place(x=40,y=612,width=90, height=50)

        cuadrito_de_min= Label(ventana_juego, borderwidth=3,relief=RIDGE,justify=CENTER,bg="#C8FFFC",text=0, font="times 18")
        cuadrito_de_min.place(x=129,y=612,width=110, height=50)

        cuadrito_de_seg= Label(ventana_juego, borderwidth=3,relief=RIDGE,justify=CENTER,bg="#C8FFFC",text=0, font="times 18")
        cuadrito_de_seg.place(x=237,y=612,width=130, height=50)
        ...
        def cronometro():
            ...
            def actualizar_crono():
                if lista_crono[2] < 59:
                    lista_crono[2] += 1
                    cuadrito_de_seg.configure(text=lista_crono[2])
                else:
                    lista_crono[2] = 0
                    ...
                    if lista_crono[1]<59:
                        lista_crono[1] += 1
                        cuadrito_de_min.configure(text=lista_crono[1])
                        ...
                        if lista_crono[0] != 24:
                            ...
                            cuadrito_de_hora.configure(text=lista_crono[0])
                    
                        
                ventana_juego.after(1000,actualizar_crono)
            ...
            cuadrito_de_hora= Label(ventana_juego, borderwidth=3,relief=RIDGE,justify=CENTER,bg="#C8FFFC",text=lista_crono[0], font="times 18")
            cuadrito_de_hora.place(x=40,y=612,width=90, height=50)

            cuadrito_de_min= Label(ventana_juego, borderwidth=3,relief=RIDGE,justify=CENTER,bg="#C8FFFC",text=lista_crono[1], font="times 18")
            cuadrito_de_min.place(x=129,y=612,width=110, height=50)

            cuadrito_de_seg= Label(ventana_juego, borderwidth=3,relief=RIDGE,justify=CENTER,bg="#C8FFFC",text=lista_crono[2], font="times 18")
            cuadrito_de_seg.place(x=237,y=612,width=130, height=50)
    ...
    #botones de abajo
    if nivel[1] == 1 or nivel[1]=="1":
        boton_iniciar = Button(ventana_juego,text="INICIAR \n JUEGO",justify=CENTER,font="times 13", bg="#F6FF69",command=cronometro)
    ...
    ultimos_botones_abajo.place(x=405,y=560,width=150,height=42)

    ultimos_botones_abajo2 = Button(ventana_juego, text = "CARGAR JUEGO",justify=CENTER,font="times 13", bg="#B060FF")
    ultimos_botones_abajo2.place(x=565,y=560,width=150,height=42)
